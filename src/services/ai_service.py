...
class AIService:
    ...
    def answer_question(self, question: str, options: List[str] = None,
    ...
    def full_process(self, question: str, options: List[str] = None,
                    question_type: str = "unknown") -> Dict:
        """
        完整流程：分类 -> 回答 -> 复审
    ...
    def get_all_statistics(self) -> Dict:
        """获取所有 Agent 的统计信息"""
        return {
            'query_agent': self.query_agent.get_statistics(),
            'classifier': {},
            'reviewer': self.reviewer.get_review_statistics(),
            'rag_chat': {}
        }
    ...
    def generate_answer_with_confidence(self, question: str, 
    ...
    def get_ai_statistics(self) -> Dict:
        """获取 AI响应统计信息（原 AIResponder.get_statistics）"""
        return self.query_agent.get_statistics()
    
    def clear_ai_history(self):
        """清空 AI 查询历史（原 AIResponder.clear_history）"""
        self.query_agent.clear_history()
